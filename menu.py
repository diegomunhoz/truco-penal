...
menuDic = {'btStart': [(14, 252), (80, 270)], 'btConfig': [(14, 416), (40, 429)], 'posBandeira': (710, 10),
           ...
           'btnServer': (121, 246), 'btnClient': (492, 246), 'btnConfirmServer': (555, 411),  'ipTxt': (248, 260), 'posEspelho': (300, 213), 'nomeSalaEspera': (14, 357), 'posAvatarSalaEspera': (24, 247), 'txtLobby': (20, 20),
...
def main():
    ...
    while True:
        ...
        #Executa o estado de jogo Multiplayer
        ...
        #Executa o estado de jogo single player
            ...
            #retorna as variáveis alteradas pelo jogo em single player
