...
# ******   Funcao: responsavel por efetuar o processamento principal de servidor do      ******
# ******           jogo, controlado a troca de informacao entre os clientes conectados   ******
...
def atribuirPontos(vencedor, turno, nomeJogador):
    ...
    if int(instruction[vencedor]) == 12:
        ...
        # Armazena o nome e o avatar do vencedor.
